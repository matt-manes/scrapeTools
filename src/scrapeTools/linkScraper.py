...
class LinkScraper:
    ...
    def scrapeImgLinks(self):
        ...
        self.imgLinks = self.processLinks(self.findAll('img', 'src')
                                           +self.findAll('img', 'data-src'))
    ...
    def scrapePage(self):
        ...
        for scrape in [self.scrapePageLinks, 
                       self.scrapeImgLinks, 
    ...
    def getLinks(self, linkType:str='all', sameSiteOnly:bool=False, 
        ...
        match linkType:
            case 'all':
                links = self.removeDuplicates(self.pageLinks 
                                               + self.imgLinks 
                                               + self.scriptLinks)
            case 'page':
